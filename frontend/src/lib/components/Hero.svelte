...
>
	<div class="text-center">
		<div class="mb-10 flex items-center justify-center md:mb-[40px]">
			<div class="relative inline-block">
				<img
					loading="lazy"
					decoding="async"
					class="h-[160px] w-[160px] rounded-full border-2 border-muted object-cover transition-transform duration-300 hover:scale-105 hover:cursor-pointer md:h-[350px] md:w-[350px]"
					src="/me.jpeg"
					alt={`${name} - Photo`}
				/>
			</div>
		...
		<h1 class="mb-6 text-5xl font-bold text-foreground md:text-7xl">
			Hi, I'm {name}
		</h1>
		...
		<a
			href={buttonHref}
			class="inline-block rounded-lg bg-primary px-8 py-3 text-primary-foreground
